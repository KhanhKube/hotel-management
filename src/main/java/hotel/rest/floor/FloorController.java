...
public class FloorController {
     ...
     */
    @GetMapping("/{floorId}")
    public ResponseEntity<Map<String, Object>> getFloorById(@PathVariable Long floorId) {
        try {
    ...
    public ResponseEntity<Map<String, Object>> deleteFloor(@PathVariable Long floorId) {
        try {
    ...
    public ResponseEntity<Map<String, Object>> checkFloorExists(@PathVariable Long floorId) {
        try {
